...
public class DailyController {
     ...
     * @return
     */
    @GetMapping(value = "getDailyMenu")
    public DailyViewModel getDailyMenu(String day, Integer dayMenuType){
        SimpleDateFormat dateFormat = new SimpleDateFormat( "yyyy-MM-dd " );
        Date a = null;
        try {
            a = dateFormat.parse("2021-11-5");
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return dailyService.getDailyMenu(a,DayMenuType.getByValue(dayMenuType));
    }
}
